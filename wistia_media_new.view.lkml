view: wistia_media_new {
  ...
  dimension: original_file_url {
    type: string
    sql: ${TABLE}.original_file_url ;;
  }

  dimension: original_filesize {
    type: number
    sql: ${TABLE}.original_filesize ;;
  }

  dimension: original_height {
    type: number
    sql: ${TABLE}.original_height ;;
  }

  dimension: original_width {
    type: number
    sql: ${TABLE}.original_width ;;
  }
