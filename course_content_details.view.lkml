view: course_content_details {
  sql_table_name: `edureka-prod`.course_content_details ;;
  ...
  dimension: subsection_content_meta_data {
    type: string
    sql: ${TABLE}.subsection_content_meta_data ;;
  }
