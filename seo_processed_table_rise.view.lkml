view: seo_processed_table_rise {
  sql_table_name: youtube_report.seo_processed_table_rise ;;
  ...
  dimension: imp_avg_change_rise {
    type: number
    sql: ${TABLE}.imp_avg_change_rise ;;
  }
  ...
  dimension: pos_avg_change_rise {
    type: number
    sql: ${TABLE}.pos_avg_change_rise ;;
  }
